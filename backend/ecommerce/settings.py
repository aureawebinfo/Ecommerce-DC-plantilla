...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://neondb_owner:npg_5Ie0ilSHxrVG@ep-silent-morning-acnc5wii-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
        conn_max_age=600
    )
}
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://ecommerce-dc-plantilla.vercel.app",
]

# Agregar corsheaders a INSTALLED_APPS y MIDDLEWARE
# ACTUALIZA LA SECCIÓN DE INSTALLED_APPS:
INSTALLED_APPS = [
